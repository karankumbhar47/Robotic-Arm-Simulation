...
class PickPlace():
    ...
    def __init__(self, height=0.32, speed=0.01):
        """
        Initialize the pick-and-place primitive.

        Parameters:
            height (float): Height for picking.
...
class PickPlaceContinuous:
    ...
    def __init__(self, speed=0.01):
        """
        Initialize the continuous pick-and-place primitive.
    ...
    def __call__(self, movej, movep, ee, action):
        """
        Execute continuous pick-and-place primitive.
...
class PushContinuous:
    ...
    def __init__(self, fast_speed=0.01, slow_speed=0.003):
        """
        Initialize the continuous pushing primitive.

        Parameters:
            fast_speed (float): Fast movement speed.
            slow_speed (float): Slow movement speed.
        """
    ...
    def __call__(self, movej, movep, ee, action):
        """
        Execute continuous pushing primitive.
